...
public final class GameCountdown implements Runnable {
    ...
    public void run() {
        ...
        if (this.running) runningTask = Bukkit.getScheduler().runTaskLater(Paintball.getInstance(), this, 20L);
    }
    ...
    public void start() {
        ...
        this.countdownDelegate.countdownChanged(seconds, seconds-secondsPassed, this);
        runningTask = Bukkit.getScheduler().runTaskLater(Paintball.getInstance(), this, 20L);
    }
